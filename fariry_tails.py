...
action1_proshed_vr = change_time_verb(action1_inf, "past")
...
hero2_sam = change_rod("сам", hero2_got_rod)
day = random.choice(["вчера", "сегодня", "на прошлой неделе", "в прошлом месяце"])
prichina = random.choice([f"{change_rod('мыл', hero2_got_rod)} зебру", f"{change_rod('пробивал', hero2_got_rod)} медведю"])
subject1_imen = ""
...
subject1_rod = rod(subject2_imen)
subject4_imen = ""
